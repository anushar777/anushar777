...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = ' '
        Entry(width=22, bg = '#262625', font = ('Anek Devanagari', 29),fg ='white', textvariable = self.equation).place(x=0, y=0)
        ...
        Button(width = 11, height = 4, text = '.', relief = 'groove', bg = '#9acbfc', command = lambda:self.show('.')).place(x=270, y=350)
        ...
        Button(width = 11, height = 4, text = 'π', relief = 'groove', bg = '#9acbfc', command = lambda:self.show(' π ')).place(x=360, y=350)
        ...
        Button(width = 11, height = 4, text = '=', relief = 'groove', bg = '#f59393', command = self.solve).place(x=180, y=350)
    ...
    def tan(self):
        ...
        if self.entry_value != ' ':
            ...
            self.entry_value = str(self.entry_value)
